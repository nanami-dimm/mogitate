...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' =>'キウイ',
            'price' => 800,
            'image' => 'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\kiwi.png',
        ...
        $param = [
            'name' =>'ストロベリー',
            'price' =>1200,
            'image' => 'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\strawberry.png',
        ...
        $param = [
            'name' =>'オレンジ',
            'price' =>850,
            'image' => 'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\orange.png',
        ...
        $param = [
            'name' =>'スイカ',
            'price' =>700,
            'image' => 'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\watermelon.png',
        ...
        $param = [
            'name' =>'ピーチ',
            'price' =>1000,
           'image' =>'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\peach.png' ,
        ...
        $param = [
            'name' =>'シャインマスカット',
            'price' =>1400,
           'image' =>'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\muscat.png' ,
        ...
        $param = [
            'name' =>'パイナップル',
            'price' =>800,
           'image' =>'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\pineapple.png' ,
        ...
        $param = [
            'name' =>'ブドウ',
            'price' =>1100,
            'image' => 'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\grapes.png',
        ...
        $param = [
            ...
            'image' => 'Local\Temp\Temp1_fruits-img.zip\fruits-img\banana.png',
        ...
        $param = [
            'name' =>'メロン',
            'price' =>900,
            'image' => 'c:\Users\nanami\AppData\Local\Temp\Temp1_fruits-img.zip\fruits-img\melon.png',
